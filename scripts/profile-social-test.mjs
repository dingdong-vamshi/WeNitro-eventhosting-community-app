...
assert.match(profile, /owner \? \['Drafts'\] : \[\]/);
assert.match(profile, /numeric trust score is not available yet/);
...
console.log('PASS: 5-platform URL normalization, unsafe URL rejection, profile permission/layout invariants, real persistence and account-change protection. No remote writes.');
