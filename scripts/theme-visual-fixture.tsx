...
function Preview() {
  ...
  else if (screen === 'activity') content = <ActivityDetailScreen activity={data.activities[0]} data={data} setData={setData} back={() => undefined} go={go} openActivity={() => undefined} openProfile={() => undefined} onOpenVibe={() => undefined} onMessageHost={async () => undefined} onOpenGroupChat={async () => undefined} onAddVibes={async () => undefined} onManagePartner={() => undefined} onEdit={() => undefined} />;
  else if (screen === 'settings') content = <ReferenceSettings data={data} setData={setData} back={() => undefined} go={go} />;
  else if (screen === 'profile') content = <ReferenceProfile openCommunity={() => undefined} data={data} setData={setData} go={go} openActivity={() => undefined} openDraft={() => undefined} openVibe={() => undefined} openSquad={() => undefined} />;
