...
assert.ok(profile.indexOf('setPerson(p.data)') < profile.indexOf("activitiesProductionService.discover({ ownerId: id"), 'Public profile identity must render before secondary profile queries finish.');
