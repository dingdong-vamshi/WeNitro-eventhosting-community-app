...
function ProfileLayout({ identity, summary, metrics, links, gallery, linksAvailable = true, owner = false, back, store, settings, editSocial, editProfile, verify, contact, message, busy, squad, nitro, tab, setTab, onPhoto, children }: {
