...
const createStyles = (c: ReferencePalette) => StyleSheet.create({
  ...
  composer: { flexDirection: 'row', alignItems: 'flex-end', gap: 8, borderTopWidth: 1, borderColor: c.border, paddingHorizontal: 10, paddingVertical: 10, backgroundColor: c.nav },
